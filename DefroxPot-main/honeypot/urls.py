...
from . import views
from .telegram_views import telegram_settings_view, save_telegram_view, test_telegram_view, export_report_view
...
urlpatterns = [
    ...
    path('notifications', telegram_settings_view, name='telegram_settings'),
    path('notifications/save', save_telegram_view, name='save_telegram'),
    path('notifications/test', test_telegram_view, name='test_telegram'),
    path('payload-analysis', views.payload_analysis, name='payload_analysis'),
]
